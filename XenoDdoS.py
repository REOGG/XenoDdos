...
def helptext ():
	os.system('clear')
        print "		python2 %s (victim/ip) -t (10000) -c (10000) -p (80)" % sys.argv[0]
        print "		WARNING: This tools not safety go use vpn for hide ur IP Address!"
	os.system('sh logo.sh')
	print "		ex : python2 XenoDdoS.py -t 1000 -c 1000 -p 80 (ip)"
	print "		-t    =    attack number"
	print "		-c    =    set sama dengan attack numbernya"
	print "		-p    =    port target"
	print "			Youtube : XenoZ CYBER"
	print "			Author : XenoZ CYBER"
        exit()
